...
<body>
	...
	$t_virhe = '#err_placeholder_001';
	$t_virhe_kuvaus = '<strong>Warning!</strong> #err_description_placeholder_002';
	...
	echo '
		...
		<div id="logo-section" class="page-header row">
			<div id="logo" class="col-lg-3"><img src="' . $t_logo_file . '" alt="SerialScan" id="logo"></div>
			<div id="company-name" class="col-lg-3"><span id="entreprise"> ' . $t_company_name . '</span></div>
			<div id="session-id" class="col-lg-3"><span id="sessionId"> ' . $t_sessionId . '</span></div>
			<div id="bouton" class="col-lg-3"><button type="submit" class="btn btn-primary center">Save & close session</button></div>
		</div>
		...
		<div id="scan_input">	<input type="text" id="scan_result"></div>
